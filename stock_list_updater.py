from src.Constant_Field import Daily_Stock_Constant,Stock_Trade_Constant,General_Constant,Market_Stock_Constant
...
#latest_daily_stock_list_df = latest_daily_stock_list_df.append({Stock_Trade_Constant.STOCK_NAME_COLUMN:Market_Stock_Constant.TW_WEIGHTED_INDEX_NAME,Stock_Trade_Constant.STOCK_NUMBER_COLUMN:Market_Stock_Constant.TW_WEIGHTED_INDEX_ID},ignore_index=True)
